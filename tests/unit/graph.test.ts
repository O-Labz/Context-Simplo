...
describe('CodeGraph', () => {
  ...
  describe('addEdge', () => {
    ...
    it('should throw error if source node does not exist', () => {
      ...
      expect(() => graph.addEdge(edge)).toThrow('Source node 1 does not exist');
    });
    ...
    it('should throw error if target node does not exist', () => {
      ...
      expect(() => graph.addEdge(edge)).toThrow('Target node 2 does not exist');
    });
  });
  ...
  describe('getCallers and getCallees', () => {
    it('should return callers of a node', () => {
      ...
      graph.addEdge(createTestEdge('e1', '1', '3'));
      graph.addEdge(createTestEdge('e2', '2', '3'));
    ...
    it('should return callees of a node', () => {
      ...
      graph.addEdge(createTestEdge('e1', '1', '2'));
      graph.addEdge(createTestEdge('e2', '1', '3'));
  ...
  describe('findShortestPath', () => {
    it('should find shortest path between nodes', () => {
      ...
      graph.addEdge(createTestEdge('e1', '1', '2'));
      graph.addEdge(createTestEdge('e2', '2', '3'));
      graph.addEdge(createTestEdge('e3', '3', '4'));
      graph.addEdge(createTestEdge('e4', '1', '4'));
  ...
  describe('analyzeImpact', () => {
    it('should find all nodes affected by a change', () => {
      const nodes = [
      ...
      graph.addEdge(createTestEdge('e1', '2', '1'));
      graph.addEdge(createTestEdge('e2', '3', '2'));
      graph.addEdge(createTestEdge('e3', '4', '3'));
  ...
  describe('findDeadCode', () => {
    it('should find unreferenced non-exported functions', () => {
      ...
      graph.addEdge(createTestEdge('e1', '4', '3'));
  ...
  describe('removeNode', () => {
    it('should remove node and clean up indexes', () => {
      const node = createTestNode('1', 'testFunc');
      graph.addNode(node);
  ...
  describe('removeNodesInFile', () => {
    it('should remove all nodes in a file', () => {
      ...
      graph.removeNodesInFile('test.ts');
